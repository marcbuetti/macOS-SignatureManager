...
class LegacyStartupControlHelper {
    ...
    static func getAppStartupState() -> String? {
            let process = Process()
            let pipe = Pipe()
            let command = "osascript \"/Applications/Signature Manager 2.app/Contents/Resources/Helper/AppStartupCheckout.scpt\""
    ...
    static func addAppToStartup() {
        let process = Process()
        let pipe = Pipe()
        let command = "osascript \"/Applications/Signature Manager 2.app/Contents/Resources/Helper/AddAppToStartup.scpt\""
    ...
    static func removeAppFromStartup() {
        let process = Process()
        let pipe = Pipe()
        let command = "osascript \"/Applications/Signature Manager 2.app/Contents/Resources/Helper/RemoveAppFromStartup.scpt\""
