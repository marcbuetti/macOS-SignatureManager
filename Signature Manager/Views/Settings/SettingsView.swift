...
struct SettingsView: View {
    ...
    @State private var navigateToRemoteManagementSettings = false
    ...
    var body: some View {
        ScrollView {
            ...
            sectionHeader(icon: "gear.badge", title: "REMOTE_MANAGEMENT")
            ...
            GroupBox {
                VStack(alignment: .leading, spacing: 6) {
                    HStack {
                        ...
                        Button(action: {
                            SecurityManager.authenticateAdminAware(
                                reason: "EDIT_MANAGEMENT_SETTINGS"
                            ) { success in
                                if success {
                                    navigateToRemoteManagementSettings = true
                                }
                            }
                        }) {
                            Text("EDIT")
        ...
        .navigationDestination(isPresented: $navigateToRemoteManagementSettings) {
